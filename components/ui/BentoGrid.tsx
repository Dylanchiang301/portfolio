...
import { GirdGlobe } from "./GirdGlobe";
...
export const BentoGridItem = ({
    ...
    const leftList = ['React.js', 'Redux', 'Redux-Saga', 'Tailwind.css']
    const rightList = ['TypeScript', 'Node.js', 'Next.js']
    const handleCopy = () => {
        navigator.clipboard.writeText('cmydylan@gmail.com');
        setCopied(true)
    }
    return (
        <div
            ...
            <div className={`${id === 6 && 'flex justify-center'} h-full`}>
                ...
                {id === 6 && (
                    <BackgroundGradientAnimation>
                        <div className="absoult z-50 inset-0 flex items-center justify-center text-white font-bold px-4 pointer-events-none text-3xl text-center md:text-4xl lg:text-7xl"></div>
                    </BackgroundGradientAnimation>
                )}
                ...
                >
                    ...
                    {id === 3 && (
                        <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                            <div className="flex flex-col gap-3 lg:gap-8">
                                ...
                                <span className="lg:py-4 lg:px-3 py-4 px-3 rounded-lg text-center bg-[#10132#]" />
                            </div>
                    ...
                    {id === 6 && (
                        <div className="mt-5 relative">
                            <div className={`aboulte -bottom-5 right-0`}>
                                <Lottie
                                    options={{
                                        loop: copied,
                                        autoplay: copied,
